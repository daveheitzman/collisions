...
if (obj == null) obj = nil;
    ...
    def.$load = function(file) {
      ...
      return $opal.load( $opal.normalize_loadable_path(file) );
        ...
        ;$opal.donate(self, ["$method_missing", "$=~", "$===", "$<=>", "$method", "$methods", "$Array", "$caller", "$class", "$copy_instance_variables", "$clone", "$initialize_clone", "$define_singleton_method", "$dup", "$initialize_dup", "$enum_for", "$to_enum", "$equal?", "$extend", "$format", "$hash", "$initialize_copy", "$inspect", "$instance_of?", "$instance_variable_defined?", "$instance_variable_get", "$instance_variable_set", "$instance_variables", "$Integer", "$Float", "$is_a?", "$kind_of?", "$lambda", "$loop", "$nil?", "$object_id", "$printf", "$private_methods", "$private_instance_methods", "$proc", "$puts", "$p", "$print", "$warn", "$raise", "$fail", "$rand", "$srand", "$respond_to?", "$send", "$public_send", "$singleton_class", "$sprintf", "$String", "$tap", "$to_proc", "$to_s", "$freeze", "$frozen?", "$respond_to_missing?", "$require", "$require_tree", "$load"]);
  })(self)
};
...
Opal.modules["corelib/comparable"] = function($opal) {
  ...
  return (function($base) {
    ...
    def['$>'] = function(other) {
      ...
      return $rb_gt($scope.get('Comparable').$normalize(cmp), 0);
    };
    ...
    def['$>='] = function(other) {
      ...
      return $rb_ge($scope.get('Comparable').$normalize(cmp), 0);
    };
    ...
    def['$<'] = function(other) {
      ...
      return $rb_lt($scope.get('Comparable').$normalize(cmp), 0);
    };
    ...
    def['$<='] = function(other) {
      ...
      return $rb_le($scope.get('Comparable').$normalize(cmp), 0);
    };
...
if (name == null) name = nil;
    ...
    def.$inspect = function() {
      ...
      if (self.$class()['$==']($scope.get('Struct'))) {
        result = $rb_plus(result, "" + (self.$class().$name()) + " ")};
...
Opal.modules["yeah/version"] = function($opal) {
  ...
  return (function($base) {
    ...
    $opal.cdecl($scope, 'VERSION', "0.4.3.dev")
...
Opal.modules["yeah/color"] = function($opal) {
  ...
  $opal.add_stubs(['$new', '$attr_reader', '$respond_to?', '$[]', '$==', '$length', '$map', '$to_i', '$chars', '$scan', '$join', '$rjust', '$to_s', '$name', '$class', '$value']);
  return (function($base) {
    var self = $module($base, 'Yeah');
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(args) {
        ...
        if ((($a = ($b = args['$[]'](0)['$respond_to?']("[]"), $b !== false && $b !== nil ?args['$[]'](0)['$[]'](0)['$==']("#") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          if (args['$[]'](0).$length()['$=='](4)) {
            self.value = ($a = ($b = args['$[]'](0)['$[]']($range(1, 3, false)).$chars()).$map, $a.$$p = (TMP_1 = function(h){var self = TMP_1.$$s || this;
if (h == null) h = nil;
            return ((("") + (h)) + (h)).$to_i(16)}, TMP_1.$$s = self, TMP_1), $a).call($b)
            } else {
            self.value = ($a = ($c = args['$[]'](0)['$[]']($range(1, 6, false)).$scan(/../)).$map, $a.$$p = (TMP_2 = function(h){var self = TMP_2.$$s || this;
if (h == null) h = nil;
        ...
        return self.hex = "#" + (($a = ($d = self.value).$map, $a.$$p = (TMP_3 = function(v){var self = TMP_3.$$s || this;
if (v == null) v = nil;
        return v.$to_s(16).$rjust(2, "0")}, TMP_3.$$s = self, TMP_3), $a).call($d).$join());
      };
...
Opal.modules["yeah/constants"] = function($opal) {
  ...
  return (function($base) {
    ...
    $opal.cdecl($scope, 'DEFAULT_DISPLAY_SIZE', [1280, 720]);

    $opal.cdecl($scope, 'DEFAULT_DISPLAY_TEXT_SIZE', 24);
...
/* Generated by Opal 0.7.0.beta1 */
Opal.modules["yeah/vec2"] = function($opal) {
  $opal.dynamic_require_severity = "error";
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  ...
  $opal.add_stubs(['$==', '$sqrt', '$**', '$atan2', '$magnitude']);
  return (function($base) {
    var self = $module($base, 'Yeah');
    ...
    (function($base) {
      ...
      (function(self) {
        ...
        self.$$proto['$equal?'] = function(ax, ay, bx, by) {
          var $a, self = this;

          return (($a = ax['$=='](bx)) ? ay['$=='](by) : $a);
        };
        self.$$proto.$magnitude = function(x, y) {
          var self = this;

          return $scope.get('Math').$sqrt($rb_plus(x['$**'](2), y['$**'](2)));
        };
        self.$$proto.$direction = function(x, y) {
          var self = this;

          return $scope.get('Math').$atan2(y, x);
        };
        self.$$proto.$length = self.$$proto.$magnitude;
        self.$$proto.$normalize = function(x, y) {
          var self = this, magnitude = nil;

          magnitude = self.$magnitude(x, y);
          return [$rb_divide(x, magnitude), $rb_divide(y, magnitude)];
        };
        self.$$proto.$add = function(ax, ay, bx, by) {
          var self = this;

          return [$rb_plus(ax, bx), $rb_plus(ay, by)];
        };
        self.$$proto.$subtract = function(ax, ay, bx, by) {
          var self = this;

          return [$rb_minus(ax, bx), $rb_minus(ay, by)];
        };
        self.$$proto.$multiply = function(ax, ay, b) {
          var self = this;

          return [$rb_times(ax, b), $rb_times(ay, b)];
        };
        self.$$proto.$divide = function(ax, ay, b) {
          var self = this;

          return [$rb_divide(ax, b), $rb_divide(ay, b)];
        };
        self.$$proto.$dot_product = function(ax, ay, bx, by) {
          var self = this;

          return $rb_plus($rb_times(ax, bx), $rb_times(ay, by));
        };
        self.$$proto.$distance_to = function(ax, ay, bx, by) {
          var self = this;

          return $scope.get('Math').$sqrt($rb_plus(($rb_minus(ax, bx))['$**'](2), ($rb_minus(ay, by))['$**'](2)));
        };
        return (self.$$proto.$direction_to = function(ax, ay, bx, by) {
          var self = this;

          return $scope.get('Math').$atan2($rb_minus(by, ay), $rb_minus(bx, by));
        }, nil) && 'direction_to';
      })(self.$singleton_class())
