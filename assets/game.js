...
Opal.modules["scene"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$[]', '$attr_accessor', '$attr_reader', '$times', '$add_box', '$pressing?', '$keyboard', '$remove_box', '$stroke_color=', '$stroke_width=', '$stroke_rectangle', '$<<', '$things', '$new', '$rand', '$nil?', '$shift']);
  ...
  return (function($base, $super) {
    ...
    def.width = def.height = def.box_count = nil;
...
Opal.modules["box"] = function($opal) {
  ...
  $opal.add_stubs(['$[]', '$attr_accessor', '$zero?', '$round', '$rand', '$y', '$height', '$scene', '$x', '$width', '$each', '$==', '$colliding?', '$stroke_color=', '$stroke_width=', '$stroke_rectangle', '$fill_color=', '$fill_rectangle', '$left', '$right', '$top', '$bottom']);
  return (function($base, $super) {
    function $Box(){};
    ...
    def.velocity_x = def.velocity_y = def.x = def.y = def.width = def.height = def.collided = def.z = def.depth = nil;
    $opal.cdecl($scope, 'COLOR', $scope.get('Color')['$[]'](201, 94, 18));

    self.$attr_accessor("x", "y", "width", "height", "velocity");
    ...
    def.$update = function(game, things, elapsed) {
      ...
      return nil;
      return ($a = ($b = things).$each, $a.$$p = (TMP_1 = function(thing){var self = TMP_1.$$s || this, $a;
if (thing == null) thing = nil;
      if (self['$=='](thing)) {
          return nil;};
        if ((($a = self['$colliding?'](thing)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.collided = true
          } else {
          return nil
    ...
    def.$draw = function(d) {
      ...
      d.$stroke_rectangle(self.x, self.y, self.width, self.height);
      if ((($a = self.collided) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    return (def['$colliding?'] = function(thing) {
      ...
      return ($a = ($b = (($c = $rb_lt(self.$left(), thing.$right())) ? $rb_gt(self.$right(), thing.$left()) : $c), $b !== false && $b !== nil ?$rb_lt(self.$top(), thing.$bottom()) : $b), $a !== false && $a !== nil ?$rb_gt(self.$bottom(), thing.$top()) : $a);
    }, nil) && 'colliding?';
  })(self, null)
};
